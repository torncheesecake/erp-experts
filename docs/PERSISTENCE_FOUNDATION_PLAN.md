...
The local backup folder is committed only via `.gitkeep`; actual backup artefacts remain ignored. Raspberry Pi backups must use an external path such as `/srv/sentinel/data/seo-ops/backups`.
